// ver4. 原本認為平行運算四個標的物會到達極限，但發現值得嘗試8個標的物一起(爆掉28800)
// 且 timing violation 在 total_cover_current_reg[2] 
...
assign idx0 = {cnt[2:0], 3'b000}; // cnt * 8 左移三位元
...
assign abs_cir_minus_x4 = (cir_minus_x4[4] == 1'd1)? (~cir_minus_x4[3:0] + 1'd1) : cir_minus_x4[3:0];
assign abs_cir_minus_y4 = (cir_minus_y4[4] == 1'd1)? (~cir_minus_y4[3:0] + 1'd1) : cir_minus_y4[3:0];
assign abs_cir_minus_x5 = (cir_minus_x5[4] == 1'd1)? (~cir_minus_x5[3:0] + 1'd1) : cir_minus_x5[3:0];
assign abs_cir_minus_y5 = (cir_minus_y5[4] == 1'd1)? (~cir_minus_y5[3:0] + 1'd1) : cir_minus_y5[3:0];
assign abs_cir_minus_x6 = (cir_minus_x6[4] == 1'd1)? (~cir_minus_x6[3:0] + 1'd1) : cir_minus_x6[3:0];
assign abs_cir_minus_y6 = (cir_minus_y6[4] == 1'd1)? (~cir_minus_y6[3:0] + 1'd1) : cir_minus_y6[3:0];
assign abs_cir_minus_x7 = (cir_minus_x7[4] == 1'd1)? (~cir_minus_x7[3:0] + 1'd1) : cir_minus_x7[3:0];
assign abs_cir_minus_y7 = (cir_minus_y7[4] == 1'd1)? (~cir_minus_y7[3:0] + 1'd1) : cir_minus_y7[3:0];
        ...
        case (state)
            ...
            SET_C2_UPDATE_C1: begin
                if (cnt == 6'd5) begin // 已經花了 5 個 cycle 判斷標的物完，去下一個座標
                    ...
                    // 八個點同時判斷完，所以要一起加上去
                    total_cover_current <= total_cover_current + 
                        ( ({5'd0, COVER_OR_C1_0} + {5'd0, COVER_OR_C1_1}) + ({5'd0, COVER_OR_C1_2} + {5'd0, COVER_OR_C1_3}) ) + 
                        ( ({5'd0, COVER_OR_C1_4} + {5'd0, COVER_OR_C1_5}) + ({5'd0, COVER_OR_C1_6} + {5'd0, COVER_OR_C1_7}) ); 
                    cnt <= cnt + 1'd1;
                end
            end
            ...
            SET_C1_UPDATE_C2: begin
                if (cnt == 6'd5) begin // 已經花了 5 個 cycle 判斷標的物完，去下一個座標
                    ...
                    // 八個點同時判斷完，所以要一起加上去
                    total_cover_current <= total_cover_current + 
                        ( ({5'd0, COVER_OR_C2_0} + {5'd0, COVER_OR_C2_1}) + ({5'd0, COVER_OR_C2_2} + {5'd0, COVER_OR_C2_3}) ) + 
                        ( ({5'd0, COVER_OR_C2_4} + {5'd0, COVER_OR_C2_5}) + ({5'd0, COVER_OR_C2_6} + {5'd0, COVER_OR_C2_7}) ); 
                    cnt <= cnt + 1'd1;
                end
            end
